...
import { SiStyledcomponents, SiTailwindcss, SiPostgresql } from 'react-icons/si'
...
export function Skills(){
    ...
    const skills = [ 
        ...
        {name_language: 'PostgreSQL', logo_skill: <SiPostgresql size='90%' />}
    ]
        ...
        <section className="w-full mt-12">
            ...
            <div className="w-full p-4 flex flex-col items-center justify-center vtm:flex-row vtm:flex-wrap ">
                ...
                {skills.map((skill, key) => {
                    return <div className='flex items-center justify-center flex-col w-36 p-2' key={key}>
